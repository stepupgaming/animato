//! Dump deterministic Glacial Crown shard + field/veil samples per frame as JSON.
//!
...
//!
//! ```sh
//! cargo run -p animato-fx-elemental --example dump_glacial_crown -- \
//!   docs/examples/fx-elemental/glacial_crown_frames.json
//! ```

use animato_fx_elemental::{GlacialCrown, GlacialCrownParams, ShardRole};
...
fn role_name(r: ShardRole) -> &'static str {
    match r {
        ShardRole::Ring => "Ring",
        ShardRole::Skirt => "Skirt",
        ShardRole::Core => "Core",
    }
}
...
fn main() {
    let out_path = std::env::args().nth(1).unwrap_or_else(|| {
        eprintln!("usage: dump_glacial_crown <output.json>");
        std::process::exit(2);
    });
    ...
    for frame in 0..frame_count {
        ...
        out.push_str(&format!(
            "{{\"t\":{},\"phase\":\"{phase}\",\"front\":{},\"u\":{},\"open\":{},\"thaw\":{},\"fade\":{},\"erupted\":{},\"light\":{{\"x\":{},\"y\":{},\"z\":{},\"intensity\":{},\"radius\":{}}},\"front_pos\":[{},{}],\"center\":[{},{}],\"hand\":[{},{},{}],",
            f4(t),
            f4(crown.front()),
            f4(crown.u()),
            f4(crown.open()),
        ...
        for (si, s) in samples.iter().enumerate() {
            ...
            out.push_str(&format!(
                "{{\"role\":\"{}\",\"x\":{},\"z\":{},\"h\":{},\"r\":{},\"e\":{},\"b\":{},\"g\":{},\"s\":{},\"lean\":{},\"fan\":{},\"yaw\":{}}}",
                role_name(s.role),
                f4(s.x),
                f4(s.z),
                f4(s.height),
